...
class predictor_delayed_train(bit_width: Int, feature_count: Int, table_size : Int, address_bit_width : Int, index_bit_width : Int, lower_bound: Int, upper_bound : Int, zero : Int, delay : Int) extends Component {
  val io = new Bundle {
