...
import percytheperceptron.memory.{cell, controller, register_file}
...
object PercyMain {
  def main(args: Array[String]) {
    SpinalVerilog(new register_file(bit_width = 16, sub_cell_count = 2, row_count = 2, address_bit_width = 1))
  }
}
